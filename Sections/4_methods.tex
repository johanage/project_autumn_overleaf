...
and after last step the procedure is to restart linearising the problem. 
...
which forms the basis for the Gauss-Newton algorithm for a NLLS problem.
...
\begin{table}[H]
    ...
    \end{tabularx}
    \caption{The parameters of interest in the NLLS problem. The loss functions are standard options in the scipy-implementation of NLLS, no loss function was defined specifically for this paper.}
